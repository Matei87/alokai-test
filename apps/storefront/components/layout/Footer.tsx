...
export default function Footer() {
  return (
    <footer className='pt-10 bg-neutral-100 md:mb-0'>
      ...
      <div className='bg-neutral-900'>
        <div className='md:flex md:mx-auto max-w-[1536px] text-sm leading-5 text-white justify-end px-4 py-10  md:py-4 md:px-10'>
          <div className='flex justify-center gap-x-4 md:self-start'>
          ...
          <p className='flex items-center justify-center py-2 text-center text-white/50 md:ml-6'>
            @2024 Alokai
          </p>
        </div>
      </div>
